...
public class FeedbackToEuipmentManufactureJPanel extends javax.swing.JPanel {
     ...
     */
    public FeedbackToEuipmentManufactureJPanel(JPanel userProcessContainer, UserAccount userAccount, PatientOrganisation patientOrganization, Enterprise enterprise, EcoSystem ecoSystem) {
        initComponents();
        ...
        for (Enterprise e : targetNetwork.getEnterpriseDirectory().getEnterpriseList()) {
            if (e instanceof EquipmentManufacturerEnterprise) {
                ...
                for(Organisation o:emfe.getOrganisationDirectory().getOrganizationList()){
                    if(o instanceof CustomerServiceOrganisation){
                        org=o;
                        break;
                    }
                }

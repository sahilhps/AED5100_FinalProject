...
public class ManageMyVitalSignsAndFitnessRecordJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageMyVitalSignsAndFitnessRecordJPanel(JPanel userProcessContainer,UserAccount userAccount, PatientOrganisation patientOrganization, Enterprise enterprise,EcoSystem ecoSystem) {
        initComponents();
    ...
    private void populateTable() {
        ...
        DoctorOrganisation doctorOrganization=null;
        for(Organisation o :enterprise.getOrganisationDirectory().getOrganizationList()){
                        if(o instanceof DoctorOrganisation){
                            DoctorOrganisation dO =(DoctorOrganisation)o;

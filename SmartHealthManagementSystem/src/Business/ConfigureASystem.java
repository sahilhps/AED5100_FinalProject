...
public class ConfigureASystem {
    ...
    public static EcoSystem configure(){
       ...
       EcoSystem ecoSystem = EcoSystem.getInstance();
        ...
        //set Organisation1 of enterprise1 of network1
        Organisation  org1 = e1.getOrganisationDirectory().createOrganization(Organisation.Type.Doctor);
        ...
        //set Organisation2 of enterprise1 of network1
        Organisation  org2 = e1.getOrganisationDirectory().createOrganization(Organisation.Type.Patient);
        ...
        Organisation  org3 = e1.getOrganisationDirectory().createOrganization(Organisation.Type.Lab);
        ...
        Organisation  org21 = e2.getOrganisationDirectory().createOrganization(Organisation.Type.CustomerService);
        org21.setName("Customer Service Organisation");
        ...
        Organisation  org31 = e3.getOrganisationDirectory().createOrganization(Organisation.Type.DrugSales);
        org31.setName("Drug Sales Organisation");
        ...
        Organisation  org100 = e100.getOrganisationDirectory().createOrganization(Organisation.Type.DrugSales);
        org100.setName("Drug Sales Organisation");
        ...
        Organisation  org41 = e4.getOrganisationDirectory().createOrganization(Organisation.Type.HHS);
        org41.setName("Health And Human Services Organisation");
        ...
        Organisation  org211 = e21.getOrganisationDirectory().createOrganization(Organisation.Type.Patient);
        ...
        Organisation  org212 = e21.getOrganisationDirectory().createOrganization(Organisation.Type.Doctor);
